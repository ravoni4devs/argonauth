...
func main() {
	var e = getHttpServer()
	var conf = argonauth.Config{}
	conf.Storage = "database.db"
	conf.UseCache = true
	conf.Debug = true
	conf.TokenSecret = "123456"
	conf.TokenAudience = "web"
	conf.TokenExpiration = time.Hour * 48
	conf.TokenIssuer = "myproject"
	conf.CookieName = "myproject"
	conf.EnableStatefulAuth = true
	conf.DisableStatelessAuth = false
	conf.DefaultAdminGroupName = "Admins"
	conf.DefaultGroupName = "Users"

	var auth = argonauth.New(conf)
